...
export class BindGroupLayoutEntry<R extends utl.Resource<any> = utl.Resource<any>> {
...
export abstract class ResourceBindingLayout<R extends utl.Resource<any> = utl.Resource<any>> {
